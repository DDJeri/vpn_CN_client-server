...
class Proposal(object):
    def __init__(self, data=None, num=1, protocol=const.ProtocolID.IKE, spi_len=0,
...
class Transform(object):
    def __init__(self, name, transform_id = 1,num = 1 , keysize=None, last=False):
        ...
        for i in name:
            transform_type , transform_value = const.TRANSFORMS[i]
            self.attributes.append(const.TRANFORM_ATTRIBUTES.pack(
            (0b1000000000000000 | transform_type), transform_value))
